...
const nicId = "";
const vmImageVersionNumber = "";
// CHANGE THIS - used as prefix for naming resources
const yourAlias = "ehtrgrq";
...
const sku = "";
const adminUsername = "nicolasAbreu";
const adminPassword = "CanoniquE78";
...
const clientId =
  ...
  "e4249fa7-8b3e-49e4-9766-179293cb134d";
const secret =
  process.env["REACT_APP_AZURE_CLIENT_SECRET"] ||
  "PY58Q~aFG1Ybh2yr-KYy6SulwSmXtkQZZ5pUDaQB";
const subscriptionId =
  process.env["REACT_APP_AZURE_SUBSCRIPTION_ID"] ||
  "437639a4-d546-47aa-a7c1-2dccb658fafe";
